...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        listWidget_timer->setGeometry(QRect(310, 40, 256, 192));
        listWidget_clocks = new QListWidget(centralwidget);
        listWidget_clocks->setObjectName(QString::fromUtf8("listWidget_clocks"));
        listWidget_clocks->setGeometry(QRect(620, 40, 256, 192));
        checkBox = new QCheckBox(centralwidget);
        checkBox->setObjectName(QString::fromUtf8("checkBox"));
        checkBox->setGeometry(QRect(280, 290, 70, 17));
        ...
        label_4->setGeometry(QRect(400, 20, 47, 13));
        label_4->setTextFormat(Qt::AutoText);
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(710, 20, 71, 16));
